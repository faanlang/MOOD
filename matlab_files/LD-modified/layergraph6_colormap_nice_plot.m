...
for ii=1:lg.npar
    ...
    if ii < 4
         eval(['subplot(' num2str(gfsf) ',' num2str(gfsc-1) ',' num2str(ii) ')']) 
    end
    if ii >3 && ii<8
         eval(['subplot(' num2str(gfsf) ',' num2str(gfsc) ',' num2str(ii+1) ')'])
    end
    if ii > 7
         eval(['subplot(' num2str(gfsf) ',' num2str(gfsc-1) ',' num2str(ii-1) ')']) 
    end
    lgSetLabelSet6(ii);
    hold on;
    for kk=lg.numind:-1:1

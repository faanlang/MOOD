function  [J1, J2] = objective_func(X,mode,colorr)
...
InitC = zeros(11,1);
InitC((1:11:11*Ncell), 1) = KmACgA/dmA;
InitC((2:11:11*Ncell), 1) = KmACgA*kpA/(dmA*dA);
InitC((9:11:11*Ncell), 1) = input_step;
 
%Model
[T,Y] = ode23s(@(t,x) model_3genes(t,x,Ncell,param),Tspan,InitC,options);
...
x8 = Y(:,8:11:11*Ncell)';
x9 = Y(:,9:11:11*Ncell)';
x10 = Y(:,10:11:11*Ncell)';
x11 = Y(:,11:11:11*Ncell)';
